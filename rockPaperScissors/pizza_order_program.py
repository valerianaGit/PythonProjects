...
def pizza_size_price_func(size_cost):
    if pizza_size_input == "small":
        ...
        return 25
pizza_size_price = pizza_size_price_func(size_cost) # not calling function? or not recognizing size_cost as the same variable?
#print("SIZE COST AFTER CALLING FUNCTION, SHOULD BE 15 " + str(pizza_size_price))
